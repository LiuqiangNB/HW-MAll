...
public class T_addr {	//�û���ַ��
	private String a_id;
	private T_user u_id;	//�û���Ϣ�����
	...
	public String toString() {
		return "T_addr [a_id=" + a_id + ", u_id=" + u_id + ", receive_name=" + receive_name + ", phone_num=" + phone_num
				+ ", phone_other=" + phone_other + ", address=" + address + "]";
	}
